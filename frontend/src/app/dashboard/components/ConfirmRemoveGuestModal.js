...
export default function ConfirmRemoveGuestModal({
  ...
  return (
    ...
    >
      {/* maxHeight + internal scroll, like every other dialog here.
          Without them this box grows past a short viewport — a phone in
          landscape, or any phone with the keyboard open — and the buttons go
          off the bottom edge with nothing to scroll. On a dialog whose two
          choices are "cancel" and "delete a guest", an unreachable button
