    ...
    <div style={{ display: 'flex', alignItems: 'center', gap: 12, flexWrap: 'wrap', marginBottom: 20 }}>
      {onSearch && (
        <div style={{ position: 'relative', flex: '1 1 240px', minWidth: 200 }}>
          <label htmlFor="admin-filter-search" style={{ position: 'absolute', width: 1, height: 1, padding: 0, margin: -1, overflow: 'hidden', clip: 'rect(0,0,0,0)', whiteSpace: 'nowrap', border: 0 }}>
            {placeholder}
          </label>
