...
// helpers are the single source of truth for that rule on the client. The backend
// enforces the same window on its public seating endpoints; the organizer dashboard
// uses authenticated endpoints and is intentionally NOT affected.
